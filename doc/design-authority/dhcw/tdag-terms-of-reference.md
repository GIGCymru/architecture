...
* Proposing new principles, standards and design patterns to Technical
  Design Authority (TDA) for adoption.
...
This group will report and escalate to the Technical Design Authority
(TDA).

## Objectives of the Group

### Key outline Objectives of this group

* Provide expert advice and opinion to support the wider assurance
  process (WIAG)

* Review and approve / defer / reject high level summaries of planned
  change

* Review and approve / defer / reject requirements specifications,
  including:
...
* Review and approve / defer / reject enterprise, solution & technical
  architecture, including:
    ...
    * Solution Architecture Design / Document (SAD)
...
Additional members will attend adhoc to support and present work to the
group.
...
| **SAD** | Solution Architecture Design / Document |
