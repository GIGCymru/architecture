...
!!! warning "Deprecated"
    This decision has been superseded by [Use Zensical for Publishing](use-zensical-for-publishing.md). Material for MkDocs was our previous documentation platform, but we have migrated to Zensical as the natural evolution created by the same team.
...
!!! info
    ...
    **Superseded by**: [Use Zensical for Publishing](use-zensical-for-publishing.md)
